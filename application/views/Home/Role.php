            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <form role="form" class="form-inline" id="form_role">
                    ...
                    <input type="text" name="name" placeholder="Enter role" id="exampleInputEmail2"
                               class="form-control">
                    </div>
...
<script>
    $(document).ready(function(){
        $("#form_role").submit(function(){
            ...
            $.ajax({
                url: "<?php echo base_url()?>index.php/Admin/addRole",
                data: data,
                type: 'post',
                dataType: "json",
...
'<td><button class="btn btn-danger" onclick="deleteRole('+o.id+')"><i class="fa fa-trash"></i></span></button></td>'
    ...
    //Delete role start
        function deleteRole(id)
        {
          ...
          {
              $.ajax({
                url : "<?php echo base_url()?>index.php/Admin/deleteRole/"+id,
                type: "POST",
                success: function(data) {
                  if(data=='success'){
                    console.log("success: ");
