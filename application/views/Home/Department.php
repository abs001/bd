...
?>
    <tr class="gradeX">
        ...
        <td><button class="btn btn-danger" id="roleDelete" onclick="deleteDept(<?php echo $value['id'];?>)"><i class="fa fa-trash"></i></span></button></td>
    </tr>
<?php
    }
?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <form role="form" class="form-inline" id="form_role">
                    ...
                    <input type="text" name="name" placeholder="Enter name" id="exampleInputEmail2"
                               class="form-control">
                    </div>
...
<script>
    $(document).ready(function(){
        $("#form_role").submit(function(){
            ...
            $.ajax({
                url: "<?php echo base_url()?>index.php/Admin/addDepartment",
                data: data,
                type: 'post',
                dataType: "json",
                success: function(data) {
                  console.log("Here: "+data);
                   ...
                   $.each(data,function(i,o){
                        ...
                        tr.append(
'<td><button class="btn btn-danger" onclick="deleteDept('+o.id+')"><i class="fa fa-trash"></i></span></button></td>'
                            );
                        $('table').prepend(tr);     
                   });
                },
    ...
    //Delete role start
        function deleteDept(id)
        {
          ...
          {
              $.ajax({
                url : "<?php echo base_url()?>index.php/Admin/deleteDept/"+id,
                type: "POST",
                success: function(data) {
                  if(data=='success'){
                    console.log("success: ");
